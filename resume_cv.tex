...
\name{Vincent}{Trinh}
%\address{2166 Stratford Drive, Milpitas, CA 95035}
\mobile{(408)-429-4761}

\email{vintrinh@ucdavis.edu}
%\homepage{www.posquit0.com}
%\github{posquit0}
\linkedin{www.linkedin.com/in/vintrinh}
%\skype{skypeid}
...
\position{Software Engineer} % Your expertise/fields %{\enskip\cdotp\enskip}

\makecvfooter{\today}{Vincent Trinh~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
